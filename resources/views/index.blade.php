            ...
            <div class="container">
                ...
                <form class="build-form" action="{{ route('configuration') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="build-name" placeholder="Например: Игровой ПК до 100 000₽" name="title" required>
                    </div>

                    <div class="form-group">
                        <label for="build-desc">Описание</label>
                        <textarea id="build-desc" placeholder="Опишите назначение сборки (игры, работа, дизайн)..." rows="3" name="description"></textarea>
                    </div>
